...
- 🔗 **Связи между оборудованием** - привязка мониторов, клавиатур, мышей к ПК, визуализация комплектов
- 📋 **Экспорт отчётов в Excel** - полный список оборудования, отчёты по сотрудникам, акты приёма-передачи
...
- ✨ Добавлены связи между оборудованием (привязка мониторов, клавиатур, мышей к ПК) с визуализацией в карточке
- ✨ Добавлен экспорт отчётов в Excel (полный список, по сотрудникам, акты приёма-передачи)

...
- 🎨 **Эффекты** - блюр-эффект при наведении на фотографии в галерее (десктоп)
- 📱 **Мобильная версия** - кнопки управления (просмотр, удалить, сделать основным) всегда видны на мобильных устройствах
- 💻 **Десктоп версия** - кнопка просмотра всегда видна, кнопки действий появляются при наведении
...
- 🐛 Улучшена десктопная версия галереи - кнопка просмотра всегда видна, кнопки действий появляются при наведении

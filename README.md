...
- 🔍 **Просмотр** - полноэкранный просмотр фотографий с минималистичным интерфейсом
...
- 📊 **Счетчик** - отображение текущего номера фотографии и общего количества
- 📱 **Адаптивный дизайн** - кнопки управления (просмотр, удалить, сделать основным) всегда видны на всех устройствах

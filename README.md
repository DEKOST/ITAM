...
- 💾 **Кэширование** - кэширование путей к миниатюрам в localStorage на 1 час для ускорения загрузки
- 🧹 **Автоматическая очистка кэша** - кэш очищается при загрузке/удалении/изменении фотографий
- 🌐 **HTTP кэширование** - статические файлы кэшируются браузером на 1 день
- 🔍 **Просмотр** - полноэкранный просмотр фотографий с информацией о файле (название и размер)
...
- 📝 В полноэкранном просмотре теперь отображается название файла и размер фотографии

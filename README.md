...
- ✨ Унифицированное форматирование дат (ЧЧ:ММ:СС ДД.ММ.ГГГГ) с использованием UTC для корректного отображения времени независимо от часового пояса пользователя
- ✨ Исправлено отображение дат в карточке оборудования (Дата добавления, Дата покупки, Гарантия до, ТО)
- 🐛 Исправлена проблема с часовыми поясами - все даты теперь отображаются в UTC формате

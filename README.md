...
### Основное
- 📊 **Дашборд** - расширенная статистика, уведомления о просроченном ТО, устаревшем оборудовании, распределение по подразделениям и типам, глобальный поиск с поддержкой раскладки клавиатуры
- 💻 **Учёт оборудования** - полный CRUD, статусы, фильтрация, сортировка по всем колонкам, автодополнение полей, массовые операции
- 🔌 **Аксессуары и периферия** - привязка мышей, клавиатур, веб-камер и других аксессуаров к оборудованию с управлением типами
...
- 🏢 **Помещения** - учёт мест размещения с группировкой по зданиям, быстрым созданием из формы оборудования и улучшенным выбором с поиском
- 🔗 **Связи оборудования** - привязка мониторов, ИБП, док-станций к ПК с улучшенным поиском по названию и сотруднику
...
- ⚡ **Быстрое создание** - создание сотрудников и подразделений прямо из формы оборудования
...
- 🔗 **Связи между оборудованием** - привязка мониторов, ИБП, док-станций к ПК, визуализация комплектов

### Импорт данных
- 📥 **Импорт сотрудников** - массовое создание сотрудников из Excel с автоматическим созданием подразделений
- 💻 **Импорт оборудования** - массовое создание оборудования из Excel с характеристиками
- 📋 **Шаблоны Excel** - готовые шаблоны с инструкциями для скачивания
- ✅ **Валидация данных** - проверка корректности данных при импорте
- 🔄 **Автоматические связи** - автоматическая привязка к сотрудникам, помещениям, подразделениям
- 🛡️ **Защита от дубликатов** - автоматическая проверка и пропуск дубликатов при повторном импорте

### Массовые операции и сортировка
...
- 🔼 **Сортировка таблиц** - сортировка по всем колонкам в списках (ФИО, Email, Подразделение, Должность для сотрудников; Название, Тип, Статус, Сотрудник, Помещение для оборудования)
- 📊 **Сортировка карточек** - сортировка подразделений, помещений и шаблонов по различным полям

### Фотографии оборудования
- 📷 **Загрузка фото** - добавление нескольких фотографий к оборудованию (JPEG, PNG, GIF, WebP до 10 MB)
- 🗜️ **Автоматическое сжатие** - сжатие изображений при загрузке без потери качества (JPEG 90%, PNG оптимизация)
- 🖼️ **Автоматические миниатюры** - создание миниатюр 300x300px при загрузке для быстрой загрузки списков
- 📝 **Транслитерация имен** - автоматическая транслитерация названий файлов из кириллицы в латиницу на основе названия оборудования
- 🔄 **Генерация миниатюр для существующих фото** - автоматическое создание миниатюр при первом запуске сервера
- 🖼️ **Галерея** - просмотр всех фотографий в карточке оборудования с кнопками управления под фотографией
- ⭐ **Основная фотография** - возможность выбрать одну фотографию как основную
- 🗑️ **Удаление** - удаление ненужных фотографий (включая миниатюры)
- 📋 **Миниатюры** - отображение основной фотографии в списке оборудования (загрузка одним запросом для высокой производительности)
- 💾 **Умное кэширование** - кэширование путей к миниатюрам в localStorage на 5 минут с версионированием
- 🧹 **Автоматическая очистка кэша** - кэш очищается при загрузке/удалении/изменении фотографий
- 🔄 **Принудительное обновление** - автоматическое обновление кэша при возврате на вкладку браузера
- 🌐 **HTTP кэширование** - статические файлы кэшируются браузером на 1 час с ETag для проверки изменений
- 🔍 **Просмотр** - полноэкранный просмотр фотографий с транслитерированным названием файла
- ⌨️ **Клавиатурная навигация** - переключение между фотографиями стрелками влево/вправо, закрытие по Escape
- 🔄 **Навигация мышью** - переключение между фотографиями кнопками под изображением
- 📊 **Счетчик** - отображение текущего номера фотографии и общего количества (исправлена ошибка индексации)
- 📱 **Адаптивный дизайн** - кнопки управления (просмотр, удалить, сделать основным) расположены под фотографией на всех устройствах
- 🔒 **Обработка конфликтов** - автоматическое добавление UUID при дублировании имен файлов
...
- 🛠️ **Сервисное меню** - опасные операции с многоуровневым подтверждением (удаление всех связей)
...
- sharp (обработка изображений, создание миниатюр, сжатие)
- HTTPS поддержка
...
- ✨ Добавлено быстрое создание сотрудников прямо из формы оборудования с возможностью создания подразделения
- ✨ Добавлено быстрое создание подразделений прямо из формы создания сотрудника
- ✨ Обновлён дашборд с уведомлениями о просроченном ТО, устаревшем оборудовании, распределением по подразделениям и типам
- ✨ Добавлена система импорта данных из Excel (сотрудники и оборудование) с шаблонами и валидацией
- ✨ Добавлена сортировка таблиц по всем колонкам (клик по заголовку для сортировки, повторный клик для смены направления)
- ✨ Добавлена группировка помещений по зданиям с переключением между группированным и списковым видом
- ✨ Добавлены улучшенные компоненты выбора сотрудников и помещений с поиском и группировкой по подразделениям/зданиям
- ✨ Добавлены связи между оборудованием (привязка мониторов, ИБП, док-станций к ПК) с улучшенным поиском по названию и сотруднику
- ✨ Добавлена система аксессуаров и периферии с привязкой к оборудованию через чекбоксы
- ✨ Добавлено управление типами аксессуаров с выбором иконок
- ✨ Улучшен поиск оборудования в связях с поиском по названию, сотруднику и инвентарному номеру
...
- ✨ Фотографии оборудования: загрузка, галерея, основная фотография, миниатюры в списке, полноэкранный просмотр
- ✨ Навигация между фотографиями в полноразмерном просмотре с кнопками влево/вправо
- ✨ Счетчик фотографий (например, "2 из 5") в полноразмерном просмотре
- 🐛 Исправлена проблема с кликами по фотографиям в галерее - теперь корректно работает полноэкранный просмотр
- 🐛 Улучшена мобильная версия галереи - добавлены кнопки управления (просмотр, удалить, сделать основным)
- 🐛 Улучшена десктопная версия галереи - все кнопки управления всегда видны (как на мобильных)
- 🐛 Убран блюр-эффект при наведении на фотографии в галерее
- ✨ Добавлена клавиатурная навигация в полноразмерном просмотре (стрелки влево/вправо, Escape для закрытия)
- 🐛 Убрано название файла и размер из верхней панели полноразмерного просмотра
- 🐛 Кнопки навигации перемещены под фотографию в полноразмерном просмотре
- ⚡ Оптимизирована загрузка миниатюр в списке оборудования - теперь все основные фотографии загружаются одним запросом вместо множества отдельных запросов
- 🗜️ Добавлено автоматическое сжатие изображений при загрузке без потери качества (JPEG 90%, PNG оптимизация)
- 🖼️ Добавлено автоматическое создание миниатюр 300x300px при загрузке для быстрой загрузки списков
- 📝 Добавлена автоматическая транслитерация названий файлов из кириллицы в латиницу на основе названия оборудования
- 💾 Добавлено кэширование путей к миниатюрам в localStorage на 1 час для ускорения загрузки
- 🌐 Добавлено HTTP кэширование статических файлов браузером на 1 день
- 🔄 Добавлена автоматическая генерация миниатюр для существующих фотографий при первом запуске сервера
- 🧹 Добавлена автоматическая очистка кэша при загрузке/удалении/изменении фотографий
- 🔒 Добавлена обработка конфликтов имен файлов - автоматическое добавление UUID при дублировании
- 🗑️ Исправлено удаление фотографий - теперь удаляются и оригиналы, и миниатюры
- 🎨 Улучшен интерфейс галереи фотографий - кнопки управления перемещены под фотографию в карточке, убрано название файла и размер из карточки
- 📝 В полноэкранном просмотре теперь отображается транслитерированное название файла и размер фотографии
- 🐛 Исправлена ошибка индексации счетчика фотографий - теперь корректно отображается номер текущей фотографии
- 🐛 Исправлено отображение названия файла в полноэкранном просмотре - теперь показывается измененное (транслитерированное) имя вместо оригинального
- 🐛 Исправлена проблема с кэшированием на мобильных устройствах - удаленные фотографии теперь корректно удаляются из кэша
- 🐛 Исправлена проблема с устаревшим кэшем - добавлено принудительное обновление при возврате на вкладку
- 🐛 Исправлена проблема с ориентацией фотографий - теперь автоматически применяется EXIF ориентация при создании миниатюр и сжатии изображений
- 🔄 Добавлено автоматическое пересоздание миниатюр с правильной EXIF ориентацией при старте сервера
- ⚡ Улучшена система кэширования - уменьшено время кэширования до 5 минут, добавлено версионирование и ETag
- 🐛 Исправлено отображение дат в истории изменений - даты полей (Дата покупки, Гарантия до, ТО) теперь форматируются в читаемый вид вместо ISO формата
- 🐛 Исправлена проблема с форматированием значений в истории изменений полей - теперь используется функция formatFieldValue для всех типов значений

...
export const duplicateEquipment = (id: string) => fetchAPI(`/equipment/${id}/duplicate`, { method: 'POST' });
...
export const deleteBrokenRelations = (equipmentId: string) => fetchAPI(`/relations/${equipmentId}/broken`, { method: 'DELETE' });
